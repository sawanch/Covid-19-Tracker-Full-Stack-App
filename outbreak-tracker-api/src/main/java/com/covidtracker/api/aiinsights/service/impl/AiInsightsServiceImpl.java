package com.covidtracker.api.aiinsights.service.impl;

import com.covidtracker.api.aiinsights.model.CovidInsightsResponse;
import com.covidtracker.api.aiinsights.model.InsightCard;
...
/**
 * AI-powered COVID-19 insights using OpenAI API
 * Generates safety recommendations and trend analysis based on country COVID data
 */
@Service
public class AiInsightsServiceImpl implements AiInsightsService {
    ...
    public CovidInsightsResponse getCountryInsights(String countryName) {
        logger.info("Generating COVID-19 insights for country: {}", countryName);
    ...
    private String buildInsightsPrompt(CovidData data) {
        ...
        return String.format(
                "You are a public health expert analyzing COVID-19 data. Provide a VARIED and NATURAL assessment.\n\n" +
                "Country: %s\n" +
                "Total Cases: %,d\n" +
                "New Cases Today: %,d (%s)\n" +
    ...
    private String callOpenAI(String prompt, double temperature) {
        ...
        systemMessage.put("content", "You are a public health expert providing COVID-19 insights. Always respond with valid JSON.");
    ...
    private String generateFallbackAssessment(CovidData data) {
        ...
        if (totalCases > 10000000) {
            return String.format("%s has experienced significant COVID-19 impact with over %,d total cases. " +
            ...
            return String.format("%s has reported %,d total COVID-19 cases with %,d currently active. " +
                    "Following public health guidelines and staying vaccinated can help protect yourself and your community.",
                    countryName, totalCases, activeCases);
        } else {
            return String.format("%s has recorded %,d total COVID-19 cases. " +
